...
<body>
    ...
    <section id="mejores-playas">
        ...
        <div class="playa">
            <img src="imagenes/mazunte.jpg" alt="Mazunte">
            <h3>Mazunte</h3>
            <p>Mazunte es conocido por su ambiente bohemio y su compromiso con la sostenibilidad. Sus playas doradas y la cercanía con la naturaleza lo hacen un lugar especial en la costa oaxaqueña.</p>
            <p><strong>Viaje redondo desde $2499 MXN</strong></p>
        </div>
        <div class="playa">
